...
// Colores definidos:
const Tupla3f ROJO = {1.0, 0.0, 0.0};
const Tupla3f VERDE = {0.0, 1.0, 0.0};
const Tupla3f AZUL = {0.0, 0.0, 1.0};

const Tupla3f AMARILLO = {1.0, 1.0, 0.0};
const Tupla3f MAGENTA = {1.0, 0.0, 1.0};
const Tupla3f CIAN = {0.0, 1.0, 1.0};

const Tupla3f GRIS = {0.5,0.5,0.5};

const Tupla3f BLANCO = {1.0, 1.0, 1.0};
const Tupla3f NEGRO = {0.0, 0.0, 0.0};
